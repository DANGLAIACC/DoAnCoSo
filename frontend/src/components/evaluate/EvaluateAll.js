...
export default function EvaluateAll() {
  ...
  const totalPage = Math.ceil(sumRateStar / pagination._limit);
    ...
    <div className="evaluate">
      {lstEvaluate.length > 0 ? (
        <>
          ...
          <div className="evaluateAll__pages">
            <ul>
